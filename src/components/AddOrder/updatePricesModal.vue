<template>
    <q-card class="q-pa-md" style="border-radius: 23.5px; font-size: 1rem; min-width: 650px">

        <q-card-section class="column items-center text-center">
          <h6 class="modal__title">Стоимость поездки изменилась</h6>
          <span class="modal__message" v-text="text"></span>
        </q-card-section>
        ...
        <div class="btn-block">
                ...
                >
                  ...
                  <span>Вызвать с новой стоимостью</span>
                </q-btn>
              </div>
