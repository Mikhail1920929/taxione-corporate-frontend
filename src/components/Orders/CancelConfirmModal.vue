<template>
    <q-card class="q-pa-md" style="border-radius: 23.5px; font-size: 1rem; width: 580px">

        <q-card-section class="column items-center text-center">
          <h6 class="modal__title">Подтверждение отмены</h6>
          <span class="modal__message">После приезда водителя за отмену заказа может взиматься оплата</span>
        </q-card-section>
        ...
        <div class="btn-block">
              ...
              <div class="btn-block">
                <q-btn type="reset" color="white" class="modal__btn modal__btn-light" unelevated no-caps rounded v-close-popup>
