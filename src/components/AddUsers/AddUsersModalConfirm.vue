<template>
    <q-card class="q-pa-md" style="border-radius: 23.5px; font-size: 1rem; width: 480px">

        <q-card-section class="column items-center text-center">
          <span class="modal__message">Пользователи с некорректно заполнеными полями не будут добавлены.</span>
        </q-card-section>
        ...
        <div class="btn-block">
              ...
              <div class="btn-block">
                <q-btn type="reset" color="white" class="modal__btn modal__btn-light" unelevated no-caps rounded v-close-popup @click="$root.$emit('AddUsersOnContinue')">
